...
Entrance clearance correction: the smaller bell sits at Blender Y −7.25, Z 5.38 with radius 0.25 and a short hanger. A restrained back-face silhouette keeps the dark sphere readable. The plaque is recessed above the entrance doors at Y −2.98, Z 5.37, with two short mounting blocks attaching it to the facade. Its proportions are 1.25 wide by 0.56 high; the doorway, frame and lattice are shortened together to make room above the door head. `art/check_entrance.py` checks the actual roof/ornament triangle intersections and rays toward the bell from the arrival viewpoint. Both ornaments pass the roof-clearance check. The plaque mounts reach the facade and its sides remain visible around the central bell rope. At desktop arrival, the participation panel covers the recessed plaque; it is visible during the approach and in the mobile layout.
